...
*Quick Exercise* Redo the competitiveness categories using `dem_margin_2026map` to create a new variable called `competitive_2024map`. Did redistricting make districts more or less competitive?
